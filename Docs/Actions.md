...
- `verify-git-status-clean`: Fails if the current Git repository has pending tracked or untracked changes, with an optional ignore list for exact repository-relative paths.
